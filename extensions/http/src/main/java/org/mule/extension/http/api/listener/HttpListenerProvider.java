 ...
 */
@Alias("listener")
public class HttpListenerProvider implements ConnectionProvider<HttpListenerConfig, Server>, Initialisable, Startable, Stoppable
{
    private static final int DEFAULT_MAX_THREADS = 128;

    //TODO: This is not available right now but I need it to get it's name for the threading stuff
    @UseConfig
