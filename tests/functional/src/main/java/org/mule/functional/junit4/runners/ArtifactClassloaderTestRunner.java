...
public class ArtifactClassloaderTestRunner extends Runner
{
    ...
    private ClassLoader buildArtifactClassloader(Class<?> klass) throws IOException, URISyntaxException
    {
        ...
        {
            logger.warn("Running test using default launcher classloader due to '{}' file has not being generated or configure to be generated by using maven-dependency-plugin", DEPENDENCIES_LIST_FILE);
        }
