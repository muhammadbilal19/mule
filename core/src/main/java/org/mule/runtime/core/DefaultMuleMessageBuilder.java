...
public class DefaultMuleMessageBuilder<PAYLOAD, ATTRIBUTES extends Serializable> implements MuleMessage
        .Builder<PAYLOAD, ATTRIBUTES>, MuleMessage.PayloadBuilder<PAYLOAD, ATTRIBUTES>
{
    ...
    {
        this.dataType = DataType.builder(dataType).mediaType(mediaType).build();
        return this;
    }

    @Override
    public MuleMessage.Builder<PAYLOAD, ATTRIBUTES> dataType(DataType<PAYLOAD> dataType)
    {
