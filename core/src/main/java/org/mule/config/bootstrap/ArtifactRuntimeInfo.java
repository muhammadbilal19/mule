...
public class ArtifactRuntimeInfo
{
    ...
    public ArtifactRuntimeInfo(String name, boolean redeploymentEnabled, Set<String> loaderOverride, String domain, Map<String, String> properties, String logConfigFile, Set<String> plugins, List<URL> sharedPluginLibs, List<String> libraries)
    {
